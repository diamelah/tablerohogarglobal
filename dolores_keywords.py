dolores = {
        ...
        "Atención del Representante": ["maltrato", "desatencion", "respuesta rapida" , "rapida respuesta", "mala atencion",
        ...
        "respeto al cliente", "mala atencion", "la atencion es una porquería", "la atención", "pesima atencion", "maltrato", "destrato",
        "falta de respeto", "grito", "no me escucho", "se ríe", "me corto", "no me atiende", "irrespetuoso", "mal educada", "mal educada",
        "falta de empatía"
        ],
        ...
        "Catec": ["cambio de decodificador", "cambio del modem", "la nueva tecnlogia", "cambio de deco", "no vino nadie"],
        
        "Baja del Servicio": [
            "gestione baja", "baja del servicio"
        ],
        
        "Corre/Dominio/Fibertel": [
            "Fibertel", "correo Fibertel"
        ],
        
        "Precio": ["precio", "caro", "cara", "muy caro", "muy alto", "alto", "es caro", "costo alto", "mucho en la factura", "precio alto", 
        "pago mucho", "precios elevados", "muy caro", "carisimo", "es una estafa", "abono elevado", "precios abusivos", 
        "aumentos constantes", "cobrar", "me cobran", "cifras altísimas", "EL COSTO", "excesivo costo", "oneroso"],
        
        "Facturación": ["factura", "facturas", "factura vencida", "facturacion", "debito automatico", "cobran", "debitaron",
        "me cobraron dos veces", "factura errónea", "error en facturación", "cobraron", "facturando", "cobran", "intereses",
        "desorden en la facturación", "facturación desastrosa", "facturación confusa", "notificacion", "facturan",
        ...
        "Indefinido": [
            "son de lo peor", "anda muy mal", "nan", "la atencion", "lenta", "mienten", "mala"
        ],
        
        "Pagos": ["pago virtual", "no puedo pagar", "problemas para pagar", "pagar", "cobraron",
        "servicio limitado por falta de pago", "no sé cómo efectuar el pago", "pago", "debitaron",
        "pago virtual y rápida", "debito automático", "cobran mora", "tarjeta de credito", "visa",
        ...
        "fueron a otro domicilio", "prometieron día y hora", "visitas pactadas"
        ...
        "Flow": ["flow", "no funciona flow", "nunca pude habilitar flow", "no tengo flow", "streaming", "decodificador", 
                 "no se usar Flow", "decodificadores", "control remoto", "guia", "grilla", "canales", 
                 "no funciona el control remoto", "quiero fibra", "canal pago", "pelicula", "sacaron canales"],
        ...
        "no atiende nadie", "nunca atienden", "me cansé de marcar", "nadie con quien hablar",
        ...
        "opciones infinitas", "muchas opciones", "te pasan por opciones", "maltrato", "destrato",
        ...
        "espera telefónica", "esperando con música", "maltrato", "destrato",
        "esperar mucho", "tiempo no vale", "esperando por teléfono"],
        
        "Delivery": [ "nunca me llegó", "no me enviaron", "demoras en la entrega", 
        "esperando la entrega", "no llegó el equipo", "no me entregraron",
        ...
        "promociones", "descuentos", "descuento", "planes", "el costo", "bonificacion", "tarifa", "aumentan", "actualizaron",
        "actualizar", "aumentos", "valores", "aumento", "valor", "incremento", "bonificaciones"],
        
        "Funcionamiento del Servicio": [# Cortes e intermitencia
        "se corta", "el servicio se corta", "el servicio se vive cortando", "intermitencia",
        "servicio se cae", "cortes frecuentes", "servicio se interrumpe", "servicio se cuelga",
        "se corta la señal", "se desconecta", "cada vez que miro una película se corta",

        # Velocidad baja
        "muy lento internet", "es muy lento", "mala velocidad", "no es rápido",
        "la velocidad es una mentira", "no es tan veloz como pensaba", "es lenta y se corta",

        # Sin servicio
        "días sin servicio", "sin internet", "no funciona", "no tengo wi fi", 
        "sigo sin teléfono", "no tengo tv", "no me funciona la fibra", "anda mal",

        # Señal o cobertura
        "mala señal", "mala cobertura", "baja cobertura y alto costo", "poca señal", 
        "no llega el wi fi", "pesima señal", "muchos microcortes"

        # Problemas técnicos
        "desperfectos técnicos", "problemas con internet y wi fi", "tecnología vieja",
        "no tiene suficiente enlace", "falla mucho", "falla muy seguido",

        # Calidad general negativa
        "mal servicio", "servicio pésimo", "servicio malísimo", "servicio flojo",
        "servicio inestable", "servicio no competitivo", "servicio horrible", 
        "es un desastre internet", "funciona con falla", "falencias en el servicio",

        # Casos específicos
        "no resuelven los desperfectos técnicos", "cortan el servicio y está pagado",
        "los canales no tienen buena señal", "decodificador", "decodificadores",
        "no toma la contraseña"],
        
        "Resolución": ["no me solucionan", "no resuelven", "no resuelven reclamos", "no puedo resolverlo", "problema",
        "no puedo resolver", "no toman mi inconveniente", "no me dan información", "complicado resolver", "maltrato", "destrato",
        ...
        "me cortaron y tuve que volver a llamar", "ventas me cortó", "me pasan de un lado al otro", "resolver",
        ...
        "App/Web/whatssApp": ["whatsapp", "web", "app mi personal", "la app movil", "personal pay", "instagram", "twitter", "canal de whatsapp"],
    }
